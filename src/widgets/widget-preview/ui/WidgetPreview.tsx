  ...
  return (
    <div className="flex flex-col gap-8 lg:flex-row lg:items-start">
      ...
      <div className="flex flex-1 flex-col items-center gap-3">
        ...
        <div className="w-full max-w-3xl overflow-hidden rounded-lg border border-[#d0d7de] bg-white shadow-sm">
          <div className="flex flex-col gap-8 p-6 sm:flex-row sm:p-8">
            <aside className="flex w-full shrink-0 flex-col gap-3 sm:w-52">
              <div className="flex h-28 w-28 items-center justify-center rounded-full border border-[#d0d7de] bg-[#f6f8fa]">
                <svg viewBox="0 0 24 24" className="h-14 w-14 fill-[#8c959f]">
              ...
              <div>
                <p className="text-lg font-semibold leading-tight text-[#1f2328]">{t('mockName')}</p>
                <p className="text-sm text-[#59636e]">{t('mockUsername')}</p>
              </div>

              <button
                type="button"
                disabled
                className="rounded-md border border-[#d0d7de] bg-[#f6f8fa] py-1 text-xs font-medium text-[#1f2328]"
              >
                {t('editProfile')}
              </button>

              <div className="flex items-center gap-1.5 text-xs text-[#1f2328]">
                <svg viewBox="0 0 16 16" className="h-3.5 w-3.5 shrink-0 fill-[#59636e]">
            ...
            <div className="min-w-0 flex-1">
              <div className="mb-4 flex items-center gap-2 border-b border-[#d0d7de] pb-3 text-sm text-[#59636e]">
                <svg viewBox="0 0 16 16" className="h-4 w-4 shrink-0 fill-[#59636e]">
              ...
              <div className="flex flex-col gap-2.5">
                <span className="h-3 w-2/3 rounded-full bg-[#eaeef2]" />
                <span className="h-3 w-full rounded-full bg-[#eaeef2]" />
                <span className="h-3 w-5/6 rounded-full bg-[#eaeef2]" />
              </div>
